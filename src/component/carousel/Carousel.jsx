...
//           <div className="carousel-item active content">
//             <img
//               src={farmer}
//               className=""
//               alt="grainMap"
...
//               </p>
//               <button className="btn btncolor ">Go to Market</button>
//               <button className="btn btncolor ">Learn More</button>
//             </div>
//           </div>
...
//       {/* <div className="row justify-content-between mx-auto mt-5  sourcing-finance">
//         <div className="col-6 col-md-12  col-12 py-5">
//           <img src={mowing} alt="tractor" />
//         </div>
//         <div className="col-6 col-md-12 py-5 ">
...
//       <div class="container event-container sourcing-finance">
...
//             <button className="btn blogbtn">Go to Blog</button>
//           </div>
//       {/* <SecondLanding /> */}
//     </div>
//   );
