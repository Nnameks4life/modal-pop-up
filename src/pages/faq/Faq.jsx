  ...
  return (
    <div className="container">
      <div className="top">
        ...
        <h3 className="pt-5 ms-5 headerr">Frequently Asked Questions</h3>
                ...
                <div class="accordion-item">
                  <h2 class="accordion-header" id="headingOne">
                    <button
                      ...
                      data-bs-target="#colllapseOne"
                      aria-expanded="true"
                      aria-controls="colllapseOne"
                    >
                      Accordion Item #1
                    </button>
                  </h2>
                ...
                <div class="accordion-item">
                  <h2 class="accordion-header" id="headingThree">
                    <button
                      ...
                      type="button"
                      data-bs-toggle="collapse"
                      data-bs-target="#collapseThreeee"
                      aria-expanded="false"
                      aria-controls="collapseThree"
                    >
                      Accordion Item #3
